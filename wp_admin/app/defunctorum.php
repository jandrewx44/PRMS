        ...
        <div class="row mb-2">
          <div class="col-12">
            <div class="btn-group btn-group-sm" role="group" aria-label="Record filters">
              ...
              <a href="defunctorum.php?home=defunctorum" class="btn btn-primary text-white">Death</a>
            </div>
          </div>
        </div>
      </div><!-- /.container-fluid -->
		  ...
		  <?php
            ...
            <div class="card">
             ...
             <h3 class="card-title"> 
			  ...
			  <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#search_death">
              ...
              <div class="card-body">
				...
				$currenturl="http://".$_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
				 if (isset($_GET['page_no']) && $_GET['page_no']!="") {
					...
					$result_count = mysqli_query($conn,"SELECT COUNT(DISTINCT DATE_FORMAT(DATE_OF_DEATH, '%Y')) As total_records FROM tbl_death");
					$total_records = mysqli_fetch_array($result_count);
					$total_records = $total_records['total_records'];
					$total_no_of_pages = ceil($total_records / $total_records_per_page);
					$second_last = $total_no_of_pages - 1; // total page minus 1
		
					$news = "SELECT COUNT(DATE_OF_DEATH) As tTotal, DATE_FORMAT(DATE_OF_DEATH, '%Y') As tDate FROM tbl_death GROUP BY DATE_FORMAT(DATE_OF_DEATH, '%Y') ORDER BY DATE_FORMAT(DATE_OF_DEATH, '%Y') DESC LIMIT $offset, $total_records_per_page"; 
				...
				?>
						...
						<div class="small-box bg-info">
						  ...
						  <a data-mytooltip="tooltip" data-placement="top" title="VIEW RECORD" href="defunctorum_view.php?year=<?=$group;?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
						</div>
					  </div>
