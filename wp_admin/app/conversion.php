        ...
        <div class="row mb-2">
          <div class="col-12">
            <div class="btn-group btn-group-sm" role="group" aria-label="Record filters">
              ...
              <a href="conversion.php?home=conversion" class="btn btn-primary text-white">Conversion</a>
		  ...
		  <?php
            ...
            <div class="card">
             ...
             <h3 class="card-title"> 
			  ...
			  <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#search_conversion">
              ...
              <div class="card-body">
				...
				?>
						...
						<div class="small-box bg-info">
						  ...
						  <a data-mytooltip="tooltip" data-placement="top" title="VIEW RECORD" href="conversion_view.php?year=<?=$group;?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
						</div>
					  </div>
