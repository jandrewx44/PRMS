  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>CONFIRMA RECORDS</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">HOME</a></li>
              <li class="breadcrumb-item active">CONFIRMA</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
		  ...
		  <?php
            ...
            <div class="card">
              ...
              <!-- <a href="#add" data-toggle="modal" class="btn bg-gradient-maroon btn-sm"><i class="fa fa-plus"></i> NEW</a> -->
			        <a href="confirmation.php" class="btn btn-primary btn-sm"><i class="fa fa-sharp fa-solid fa-left"></i> BACK</a>
              </div>
              </h3>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                   ...
                   $ShowYear = $_GET['year'];
                   if($ShowYear=='NULL'){
                     $sql = "SELECT * FROM tbl_confirmation WHERE DATE_CONFIRMED='".$ShowYear."' ORDER BY CHILD_NAME ASC";
                     $query = $conn->query($sql);
                   }else{
                     $sql = "SELECT * FROM tbl_confirmation WHERE DATE_FORMAT(DATE_CONFIRMED, '%Y')='".$ShowYear."' ORDER BY CHILD_NAME ASC";
                     $query = $conn->query($sql);
                   }
				          	$cnt=1;
