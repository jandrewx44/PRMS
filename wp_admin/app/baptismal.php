              ...
              <div class="card-body">
				...
				$currenturl="http://".$_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
				 if (isset($_GET['page_no']) && $_GET['page_no']!="") {
					...
					$result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records, DATE_FORMAT(DATE_OF_BIRTH, '%Y') As tDate FROM tbl_baptismal");
				...
				?>
						...
						<div class="small-box bg-gradient-info">
						  ...
						  <a data-mytooltip="tooltip" data-placement="top" title="VIEW RECORD" href="baptismal_acView.php?year=<?=$group;?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
						</div>
					  </div>
