  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>Certificate of Marriage </h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Marriage Record</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
             ...
             <i class="fa fa-solid fa-folder-open"></i> Records
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-hover text-nowrap">
                  ...
                  <tbody>
					      <?php
                    $sql = "SELECT * FROM tbl_marriage_certificate ORDER BY DATE_ISSUED DESC";
                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          <td><?=$cnt; ?></td>
                          <td><?=$row['GROOM_NAME']; ?> <i class="fa fa-regular fa-arrows-left-right-to-line text-primary"></i><?=$row['BRIDE_NAME']; ?></td>
                          <td><?=$row['GIVEN_DAY']; ?> <?=$row['GIVEN_MONTH']; ?>, <?=$row['GIVEN_YEAR']; ?></td>
                          <td><?=$row['SOLEMNIZING_PRIEST']; ?></td>
