    ...
    <section class="content-header">
	 ...
	 <section class="content">
      <div class="container-fluid">
        ...
        <a data-mytooltip="tooltip" data-placement="top" title="PRINT" href="<?='marriage-certification-pdf-print.php?MARRIAGERECORDID='.$ID;?>" target="_blank" class="btn bg-gradient-teal btn-sm"><i class="fa-solid fa fa-print"></i> Print</a>
			<a href="marriage.php" class="btn bg-gradient-maroon btn-sm"><i class="fa-solid fa fa-arrow-left text-white"></i> BACK</a>
            </div>
          	</div>
            </div>
            <!-- /.card -->
